...
ffuf -H "User-Agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36" -e / -mc all -fc 404,400 -w ~/wordlists/$n.txt -u $u -o /tmp/$random/results.json -od /tmp/$random/bodies/ -of json $add
